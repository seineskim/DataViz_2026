...
\vspace{2.0em}
	...
	This project performs a multi-dimensional analysis by integrating three core datasets extracted from the Korean Statistical Information Service (KOSIS). To ensure data integrity, several "tinkering" processes were conducted, including indexing (rebasing) and the derivation of new demographic variables.
